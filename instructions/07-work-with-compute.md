...
ms.locfileid: "137894533"
---
# <a name="work-with-compute"></a>处理计算

所有 Python 代码都在环境的上下文中运行，环境决定了可用的 Python 包。 代码可以在本地工作站的环境中运行，也可以在其他计算目标上运行，例如在群集上运行以提升可缩放性。

在本练习中，你将了解环境和计算目标，可使用它们在 Azure 机器学习中运行试验。 
...
## <a name="work-with-environments-and-compute-targets"></a>处理环境和计算目标
