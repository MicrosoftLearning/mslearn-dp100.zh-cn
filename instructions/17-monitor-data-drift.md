...
ms.locfileid: "137894464"
---
# <a name="monitor-data-drift"></a>监视数据偏移

数据随时间变化的趋势会降低模型所做预测的准确度。 监视此数据偏移，并在必要时进行重新训练，是确保机器学习解决方案继续准确预测的重要方法。
...
## <a name="monitor-data-drift-for-a-dataset"></a>监视数据集的数据偏移
